...
- **Multiple AI CLIs pre-installed** -- Claude Code, OpenAI Codex, Google Gemini CLI, OpenCode, Pi, DeepSeek Harness (web UI, JupyterLab), aiagent, Ollama. All wired through the local router by default.
