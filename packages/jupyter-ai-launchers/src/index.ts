...
const opencodeSvg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
  ...
  <path d="M9 8l-3 4 3 4" stroke="#f97316" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" fill="none"/>
  <path d="M15 8l3 4-3 4" stroke="#f97316" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" fill="none"/>
</svg>`;

// Pi: a pi glyph on a terminal block (no official SVG available)
const piSvg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
  <rect x="2" y="3" width="20" height="18" rx="3" fill="#18181b"/>
